...
sudo -u certistock env HOME="$APP_DIR" PM2_HOME="$PM2_HOME_DIR" bash -lc "set -a; source '$APP_DIR/.env'; set +a; pm2 startOrReload ecosystem.config.cjs --only certistock-api --update-env"
